...
export const demoImages: Record<DemoImageKey, DemoImageAsset> = {
  ...
  "clinic-front-02": {
    src: "/districts/clinics/clinic-front-02.jpg",
  ...
  "mobile-field-report": {
    src: "/districts/clinics/mobile-field-report.jpg",
  ...
  "district-operations-room": {
    src: "/districts/clinics/district-operations-room.jpg",
  ...
  "patient-routing-context": {
    src: "/districts/clinics/patient-routing-context.jpg",
