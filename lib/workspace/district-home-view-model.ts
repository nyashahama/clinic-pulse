...
import type { SyncSummaryApiResponse } from "@/lib/workspace/api-types";
import {
  buildDistrictCommandCenter,
  type DistrictSeverityLabel,
} from "@/lib/workspace/district-command-center";
import { buildDistrictCommandClinicInputs } from "@/lib/workspace/district-command-center-adapter";
import {
...
} from "@/lib/workspace/district-interventions-view-model";
import { getActiveAlerts } from "@/lib/workspace/selectors";
