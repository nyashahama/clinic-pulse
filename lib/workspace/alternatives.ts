...
import { mapApiAlternative } from "@/lib/workspace/api-mappers";
import { buildFinderAlternatives } from "@/lib/workspace/finder";
...
export async function loadAlternativeRecommendations({
  ...
  try {
    ...
    // while running the workspace against a local or temporarily unavailable API.
