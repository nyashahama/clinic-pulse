...
import { getAlternativeClinics } from "@/lib/workspace/selectors";
import type {
  Alert,
  AuditEvent,
  Clinic,
...
function resolveSourceClinic(state: WorkspaceState) {
...
function resolveRecommendedAlternative(state: WorkspaceState) {
