type WorkspaceViewport = "desktop" | "mobile";

type WorkspaceRouteChecklistEntry = {
  path: string;
  proofMoment: string;
  viewports: WorkspaceViewport[];
};

export const phaseOneWorkspaceRouteChecklist: WorkspaceRouteChecklistEntry[] = [
  {
    path: "/",
