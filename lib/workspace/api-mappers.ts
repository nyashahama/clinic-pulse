...
import type { FinderAlternative } from "@/lib/workspace/finder";
...
export type ApiWorkspaceHydrationPayload = {
...
export function mapApiWorkspaceHydrationToState(
  payload: ApiWorkspaceHydrationPayload,
  baseState: WorkspaceState,
): WorkspaceState {
  ...
  return {
    ...
    clinicStates,
    reports,
    // Alerts stay seeded locally until the backend exposes alert hydration.
