...
export const heroSignalPackets: HeroSignalPacket[] = [
  ...
  { id: "packet-pharmacy-service", label: "Pharmacy", detail: "service affected", tone: "critical", delay: "0.8s", x: "17%", y: "66%" },
...
export const heroMapPulses: HeroMapPulse[] = [
  { id: "map-mabopane", label: "Mabopane Station", tone: "critical", x: 36, y: 58, active: true },
