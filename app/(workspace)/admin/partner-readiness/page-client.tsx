...
import { PartnerReadinessPanel } from "@/components/workspace/partner-readiness-panel";
  ...
  return (
    <div data-admin-module="partner-readiness">
      <PartnerReadinessPanel
        readiness={readiness}
        onCreateSandboxKey={handleCreateSandboxKey}
        ...
        pendingActions={{
          createSandboxKey: partnerActionInFlight,
