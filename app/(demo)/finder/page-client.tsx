      ...
      <section className="rounded-lg border border-border-subtle bg-bg-default p-4 shadow-sm">
        ...
        <div className="mt-4 rounded-lg border border-border-subtle bg-bg-subtle p-3 text-sm text-content-subtle">
          <div className="flex items-center gap-2">
            ...
            <span>
              Current query: <span className="font-medium text-content-emphasis">{query || "all"}</span> ·
              service: <span className="font-medium text-content-emphasis">{service || "all"}</span> ·
              status: <span className="font-medium text-content-emphasis">{status || "all"}</span>
            </span>
          </div>
        </div>
      </section>
