      ...
      <AuthStagger className="grid gap-4">
        ...
        <AuthFadeIn>
          <motion.button
            ...
            className="inline-flex h-11 w-full shrink-0 items-center justify-center rounded-full border border-white bg-white px-4 text-sm font-semibold text-neutral-950 shadow-[0_12px_34px_rgba(0,0,0,0.28)] transition-colors hover:bg-white/88 disabled:cursor-not-allowed disabled:opacity-50"
          >
