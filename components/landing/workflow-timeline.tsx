...
export function WorkflowTimeline() {
  return (
    <LandingSection id="flow">
      <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-950 px-6 py-14 text-white shadow-2xl sm:px-10 lg:px-16">
