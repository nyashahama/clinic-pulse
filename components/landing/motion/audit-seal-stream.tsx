      ...
      <div className="flex w-max gap-3 [animation:clinic-rail-scroll_30s_linear_infinite]">
        {streamEvents.map((event, index) => (
          <div
            ...
            className="flex min-w-48 shrink-0 items-center gap-2 rounded-lg border border-emerald-200 bg-white/90 px-3 py-2 text-xs text-slate-700 shadow-sm dark:border-emerald-900/50 dark:bg-card/90 dark:text-foreground dark:shadow-black/20"
          >
            <ShieldCheck
            ...
            <span className="min-w-0">
              ...
              <span className="block truncate text-[11px] text-slate-700 dark:text-foreground">
                {event.detail}
              </span>
            </span>
          </div>
