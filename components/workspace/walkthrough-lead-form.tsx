...
type WalkthroughLeadFormProps = {
  onSubmit: (lead: WalkthroughLeadFormInput) => void;
  submitLabel?: string;
...
export type { WalkthroughLeadFormInput };
