...
import { ServiceList } from "@/components/workspace/service-list";
import { StatusBadge } from "@/components/workspace/status-badge";
import type { AlternativeRecommendation } from "@/lib/workspace/alternatives";
    ...
    <section className="rounded-lg border border-border-subtle bg-bg-default p-4 shadow-sm">
      ...
      {unavailable ? (
        <div className="mt-4 space-y-3">
          <div className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-3 text-sm text-amber-900 dark:border-amber-900/60 dark:bg-amber-950/35 dark:text-amber-200">
